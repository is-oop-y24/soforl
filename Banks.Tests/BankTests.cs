...
namespace Banks.Tests
{
    public class BankTests
    {
        ...
        public void CheckTransferMoneyTwoDebitAccounts_ThrowException()
        {
            ...
            Client client1 = _centralBank.AddClient("Fedor", "Petrov");
            Client client2 = _centralBank.AddClient("Petr", "Petrov");
        ...
        public void CheckTransferMoneyTwoDebitAccounts()
        {
            ...
            Assert.AreEqual(21000, account1.GetSum());
        }
        ...
        public void CancelTransaction_()
        {
            ...
            _centralBank.AddClientPassport("meow", client2);
            account1.TransferPartMoney(2000, account2);
            bank.CancelTransaction(account2, account1, account2.GetTransactions().Last());
            Assert.AreEqual(14000, account2.GetSum());
        }
